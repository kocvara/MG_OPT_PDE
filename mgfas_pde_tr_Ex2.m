function [xn]=mgfas_pde_tr_Ex2(levels,level,Aglob,fl,intnodel,cf,Pro,vh,x,xl,xu,iiii)
%--------------------------------------------------------------------------
...
%--------------------------------------------------------------------------
%
% Truncated multigrid for Example 2
...
%% level-one exact solution
     ...
     [xn,k]=gp_pde1_con_Ex2(x,Aco,ff,intnodel{1},vh,10000,1e-9,xl,xu);
        
else
    PP=Pro{l}';
    P = PP(intnodel{l},intnodel{l-1});
%% pre-smoothing
    [x,kk]=gp_pde1_con_Ex2(x,Aco,ff,intnodel{level},vh,gpiter,1e-11,xl,xu,level);
...
%%
    ...
    [dum,grad] = pde1_vh_Ex2(x,Aco,ff,intnodel{level},vh);
    grad(ndot)=0;
    vH1=P'*grad;
    ...
    [dum,vH2] = pde1_vh_Ex2(xH,AcoH,ffH,intnodel{level-1},zeros(size(xH)));
    ...
    [cor]=mgfas_pde_tr_Ex2(levels,l-1,AcoH,ffH,intnodel,cf,Pro,vH,xH,xl1,xu1,iiii);
...
%% post-smoothing
    ...
    [xn,kk]=gp_pde1_con_Ex2(xc,Aco,ff,intnodel{level},vh,gpiter,1e-11,xl,xu,level);
