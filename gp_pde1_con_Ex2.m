function [x,gamma_s]=gp_pde1_con_Ex2(x0,A,ff,intnode,vh,minit,tol,xl,xu,level)
%--------------------------------------------------------------------------
...
%--------------------------------------------------------------------------
%
% gradient projection method for box constrained Example 2
...
[obj0,grad] = pde1_vh_Ex2(x,A,ff,intnode,vh); obj = obj0;
compl = 1e20;
...
while ( compl > tol && k < minit)
    ...
    [objn,gradn] = pde1_vh_Ex2(xn,A,ff,intnode,vh);
